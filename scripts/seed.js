...
try {
  ...
  const teachers = [
    {
      ...
      subject: "Matematika",
      employeeType: "PNS",
      position: "Guru Matematika Kelas 7-9",
      phone: "08111111111",
    ...
    },
    {
      ...
      employeeType: "PPPK",
      position: "Wali Kelas 8A & Guru Bahasa Indonesia",
      phone: "08222222222",
    ...
    },
    {
      ...
      position: "Guru Olahraga & Kesehatan",
      phone: "08333333333",
      email: "ahmad@sekolah.edu",
    },
    {
      username: "kepsek",
      name: "Dr. Indira Sari, S.Pd., M.M.",
      nip: "KS001",
      subject: "Pendidikan",
      employeeType: "PNS",
      position: "Kepala Sekolah",
      phone: "08444444444",
      email: "kepala@sekolah.edu",
    },
  ];
  ...
  await dbHelpers.setSetting(
    "allow_early_checkin",
    "07:00:00",
    "Waktu paling awal check-in",
  );
  await dbHelpers.setSetting(
    "allow_late_checkout",
    "20:00:00",
    "Waktu paling akhir check-out",
  );
